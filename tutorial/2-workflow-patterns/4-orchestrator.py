...
- Target Length: target word count for this section
...
class BlogOrchestrator:
    ...
    def write_blog(
        self, topic: str, target_length: int = 1256, style: str = "informative"
    ) -> Dict:
...
if __name__ == "__main__":
    ...
    result = orchestrator.write_blog(
        topic=topic, target_length=1256, style="technical but accessible"
    )
